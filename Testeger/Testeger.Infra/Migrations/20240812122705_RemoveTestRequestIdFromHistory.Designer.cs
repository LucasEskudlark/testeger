...
namespace Testeger.Infra.Migrations
{
    ...
    [Migration("20240812122705_RemoveTestRequestIdFromHistory")]
    partial class RemoveTestRequestIdFromHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Testeger.Domain.Models.Entities.Project", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 8, 12, 12, 27, 4, 910, DateTimeKind.Utc).AddTicks(9245))
            ...
            modelBuilder.Entity("Testeger.Domain.Models.Entities.TestCase", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 8, 12, 12, 27, 4, 912, DateTimeKind.Utc).AddTicks(5469))
                        .HasColumnName("CreatedDate");
            ...
            modelBuilder.Entity("Testeger.Domain.Models.Entities.TestRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 8, 12, 12, 27, 4, 911, DateTimeKind.Utc).AddTicks(2957))
                        .HasColumnName("CreatedDate");
                    ...
                    b.OwnsMany("Testeger.Domain.Models.ValueObjects.TestCaseHistory", "History", b1 =>
                        {
                            ...
                            b1.Property<DateTime>("ChangedDate")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("datetime")
                                .HasDefaultValue(new DateTime(2024, 8, 12, 12, 27, 4, 915, DateTimeKind.Utc).AddTicks(7265))
                    ...
                    b.OwnsMany("Testeger.Domain.Models.ValueObjects.TestRequestHistory", "History", b1 =>
                        {
                            ...
                            b1.Property<DateTime>("ChangedDate")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("datetime")
                                .HasDefaultValue(new DateTime(2024, 8, 12, 12, 27, 4, 912, DateTimeKind.Utc).AddTicks(1910))
                                .HasColumnName("ChangedDate");
