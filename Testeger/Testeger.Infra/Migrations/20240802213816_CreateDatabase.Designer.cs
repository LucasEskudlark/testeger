...
namespace Testeger.Infra.Migrations
{
    ...
    [Migration("20240802213816_CreateDatabase")]
            ...
            modelBuilder.Entity("Testeger.Domain.Models.Entities.Project", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 8, 2, 21, 38, 15, 845, DateTimeKind.Utc).AddTicks(5894))
            ...
            modelBuilder.Entity("Testeger.Domain.Models.Entities.TestCase", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 8, 2, 21, 38, 15, 848, DateTimeKind.Utc).AddTicks(5625))
                        .HasColumnName("CreatedDate");
            ...
            modelBuilder.Entity("Testeger.Domain.Models.Entities.TestCaseResult", b =>
                {
                    ...
                    b.Property<string>("SavedTimes")
                        .IsRequired()
                        .HasColumnType("longtext");

                    b.Property<string>("SavedTimesJson")
                        .IsRequired()
                        .HasColumnType("json")
                    ...
                    b.ToTable("TestCaseResult", null, t =>
                        {
                            t.Property("SavedTimes")
                                .HasColumnName("SavedTimes1");
                        });
                });
            ...
            modelBuilder.Entity("Testeger.Domain.Models.Entities.TestRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 8, 2, 21, 38, 15, 846, DateTimeKind.Utc).AddTicks(758))
                        .HasColumnName("CreatedDate");
            ...
            modelBuilder.Entity("Testeger.Domain.Models.Entities.TestCase", b =>
                {
                    ...
                    b.OwnsOne("Testeger.Shared.Models.ValueObjects.TestCaseDetails", "Details", b1 =>
                        {
                    ...
                    b.OwnsMany("Testeger.Shared.Models.ValueObjects.TestCaseHistory", "History", b1 =>
                        {
                            b1.Property<string>("TestCaseId")
                                .HasMaxLength(36)
                                .HasColumnType("varchar(36)")
                            ...
                            b1.Property<DateTime>("ChangedDate")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("datetime")
                                .HasDefaultValue(new DateTime(2024, 8, 2, 21, 38, 15, 853, DateTimeKind.Utc).AddTicks(8803))
                    ...
                    b.OwnsMany("Testeger.Domain.Models.ValueObjects.TestRequestHistory", "History", b1 =>
                        {
                            ...
                            b1.Property<DateTime>("ChangedDate")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("datetime")
                                .HasDefaultValue(new DateTime(2024, 8, 2, 21, 38, 15, 848, DateTimeKind.Utc).AddTicks(635))
                                .HasColumnName("ChangedDate");
