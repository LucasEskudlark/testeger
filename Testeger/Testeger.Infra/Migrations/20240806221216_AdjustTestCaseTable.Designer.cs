...
namespace Testeger.Infra.Migrations
{
    ...
    [Migration("20240806221216_AdjustTestCaseTable")]
    partial class AdjustTestCaseTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Testeger.Domain.Models.Entities.Project", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 8, 6, 22, 12, 16, 103, DateTimeKind.Utc).AddTicks(9326))
            ...
            modelBuilder.Entity("Testeger.Domain.Models.Entities.TestCase", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 8, 6, 22, 12, 16, 112, DateTimeKind.Utc).AddTicks(4297))
                        .HasColumnName("CreatedDate");
            ...
            modelBuilder.Entity("Testeger.Domain.Models.Entities.TestRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 8, 6, 22, 12, 16, 104, DateTimeKind.Utc).AddTicks(2532))
                        .HasColumnName("CreatedDate");
                    ...
                    b.OwnsMany("Testeger.Domain.Models.ValueObjects.TestCaseHistory", "History", b1 =>
                        {
                            ...
                            b1.Property<DateTime>("ChangedDate")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("datetime")
                                .HasDefaultValue(new DateTime(2024, 8, 6, 22, 12, 16, 116, DateTimeKind.Utc).AddTicks(1183))
                    ...
                    b.OwnsMany("Testeger.Domain.Models.ValueObjects.TestRequestHistory", "History", b1 =>
                        {
                            ...
                            b1.Property<DateTime>("ChangedDate")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("datetime")
                                .HasDefaultValue(new DateTime(2024, 8, 6, 22, 12, 16, 111, DateTimeKind.Utc).AddTicks(8300))
                                .HasColumnName("ChangedDate");
