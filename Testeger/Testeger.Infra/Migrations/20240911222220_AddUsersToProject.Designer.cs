...
namespace Testeger.Infra.Migrations
{
    ...
    [Migration("20240911222220_AddUsersToProject")]
            ...
            modelBuilder.Entity("Testeger.Domain.Models.Entities.Project", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 9, 11, 22, 22, 19, 963, DateTimeKind.Utc).AddTicks(5542))
            ...
            modelBuilder.Entity("Testeger.Domain.Models.Entities.TestCase", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 9, 11, 22, 22, 19, 966, DateTimeKind.Utc).AddTicks(5804))
                        .HasColumnName("CreatedDate");
            ...
            modelBuilder.Entity("Testeger.Domain.Models.Entities.TestRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 9, 11, 22, 22, 19, 964, DateTimeKind.Utc).AddTicks(2913))
                        .HasColumnName("CreatedDate");
                    ...
                    b.OwnsMany("Testeger.Domain.Models.ValueObjects.TestCaseHistory", "History", b1 =>
                        {
                            ...
                            b1.Property<DateTime>("ChangedDate")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("datetime")
                                .HasDefaultValue(new DateTime(2024, 9, 11, 22, 22, 19, 972, DateTimeKind.Utc).AddTicks(2473))
                    ...
                    b.OwnsMany("Testeger.Domain.Models.ValueObjects.TestRequestHistory", "History", b1 =>
                        {
                            ...
                            b1.Property<DateTime>("ChangedDate")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("datetime")
                                .HasDefaultValue(new DateTime(2024, 9, 11, 22, 22, 19, 965, DateTimeKind.Utc).AddTicks(9197))
                                .HasColumnName("ChangedDate");
